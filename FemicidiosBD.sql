...
/********************************************************************************************************/
/* IDENTIDAD DE GENERO ESTANDAR GENERAL*/
use femicidios;
...
INSERT INTO identidadesGenerosEstandar (id, nombre,descripcion) VALUES
                                                                    (1,'Cis Hombre', 'Hombre identificado con el género que se le asignó al nacer.'),
...
INSERT INTO `ta_tipovictima` VALUES
                                 (1,'Principal','La victima principal del femicidio'),
...
INSERT INTO ta_modalidades (`CV_Titulo`,`CV_Descripcion`) VALUES
...
INSERT INTO ta_orientacionessexuales(CI_Codigo,CV_Titulo,CV_Descripcion) VALUES
                                                                             (1,"Lesbiana","Se reconoce lesbiana."),
...
INSERT INTO ta_tipolugar (`CV_Titulo`, `CV_Descripcion`) VALUES
                                                             ('Domicilio Víctima' , 'Lugar de residencia particular de la víctima'),
                                                             ('Domicilio Víctimario' , 'Lugar de residencia particular del víctimario'),
                                                             ('Domicilio Particular' , 'Lugar de residencia no necesariamente de la víctima o victimario'),
                                                             ('Espacio Abierto' , 'Calle o transporte público'),
                                                             ('Puesto de Trabajo' , 'Lugar en el que se desempeñan sus tareas laborales habituales '),
                                                             ('Institución Educativa' , 'Escuelas u otras instituciones educativas'),
                                                             ('Prisión' , 'Instituciones penales o correccionales'),
                                                             ('Institución' , 'Entornos de atención institucional (incluye: hospitales, intituciones)'),
                                                             ('Otro' , ''),
                                                             ('Se desconoce', '');
...
INSERT INTO `femicidios`.`ta_tiporelacion` ( `CV_titulo`, `CV_descripcion`) VALUES
                                                                                ('Padre', 'Victimario es padre de la víctima'),
                                                                                ('Madre', 'Victimario es madre de la víctima.'),
                                                                                ('Padrastro', 'Victimario es padrastro de la víctima.'),
                                                                                ('Madastra', 'Victimario es madrastra de la víctima.'),
                                                                                ('Tutor/a', 'Victimario es tutor/a de la víctima.'),
                                                                                ('Esposo/a', 'Victimario es esposo/a de la víctima.'),
                                                                                ('Concubino/a', 'Victimario es concubino/a de la víctima.'),
                                                                                ('Novio/a', 'Victimario es novio/a de la víctima.'),
                                                                                ...
                                                                                ('Autoridad', 'Por autoridades oficiales'),
                                                                                ('Desconocido/a', 'Victimario no es conocido/a por la víctima.'),
                                                                                ('Se desconoce', 'Se desconoce el tipo de relación.');
...
INSERT INTO `femicidios`.`ta_tipoorganismo`  (`CV_Titulo`,  `CV_Descripcion`)  VALUES
                                                                                   ('Policial'  , 'Organismo policial incluyendo servicios de emergencia'),
                                                                                   ('Judicial'  , 'Organismo Judicial a nivel nacional'),
                                                                                   ('Fiscalia'  , 'Fiscalia'),
                                                                                   ('Salud'  , 'Institucion de Salud'),
                                                                                   ('Ministerio de Desarrollo Social'  , 'Ministerio de Desarrollo Social'),
                                                                                   ('Justicia Provincial'  , 'Poder Judicial a nivel provincial'),
                                                                                   ('Ministerio Publico Fiscal'  , ' '),
                                                                                   ('Ministerio de Justicia'  , 'Ministerio de Justicia'),
                                                                                   ('Medicina'  , 'Medicina Legal o Forense'),
                                                                                   ('Secretaria de la Mujer'  , 'Ministerio o Secretaria de la Mujer'),
                                                                                   ('Otro'  , ''),
                                                                                   ('Se desconoce', '');


/****************************        TABLAS QUE NO LLEVAN RELACION CON OTRAS    *************************/
...
INSERT INTO codigopaises VALUES
...
CREATE TABLE ta_procesojudicial (
                                    ...
                                    PRIMARY KEY (CI_Id));
ALTER TABLE ta_procesojudicial
    ADD COLUMN CV_Agravantes VARCHAR(50) AFTER CI_Personas_Imputadas;
ALTER TABLE ta_procesojudicial
    ADD COLUMN CV_Tipo_Delito VARCHAR(30) AFTER CV_Partes;

INSERT INTO ta_procesojudicial VALUES (1,'Estado',700244,'2023-10-21',10,'Null','Partes','Null'),
                                      (2,'Estado',3345453,'2022-10-22',9,'Null','Partes','Null');
...
VALUES ("Tiene acceso a todo", "Administrador"),("No tiene acceso a las pantallas del admin", "Convencional"),("No tiene acceso a las acciones", "Consulta");
...
CREATE TABLE femicidios.TA_Hechos (
                                      ...
                                      CD_Fecha VARCHAR(20) NOT NULL,
                                      CV_Detalles VARCHAR(255) NOT NULL,
                                      PRIMARY KEY (CI_Id));
...
INSERT INTO TA_Organismos ( `CV_Nombre`, `CV_Rol`, `CV_Tipo_Organismo`, `CV_Nacionalidad`, `CV_Contacto`) VALUES
    ( 'Organismo', 'Admin', 'A', 'Costarrikeno', '666') ;
...
/****************************        TABLAS QUE SI LLEVAN RELACION CON OTRAS    *************************/
...
CREATE TABLE `ta_lugar` (
                            ...
                            `CI_Pais` int NOT NULL,
                            PRIMARY KEY (`CI_Codigo`), KEY `CI_Hecho` (`CI_Hecho`),
                            CONSTRAINT `ta_lugar_ibfk_1` FOREIGN KEY (`CI_Hecho`) REFERENCES `ta_hechos` (`CI_Id`) );
SELECT `ta_lugar`.`CI_Codigo`,
       `ta_lugar`.`CI_Hecho`,
       `ta_lugar`.`CV_Descripcion`,
       `ta_lugar`.`CI_Tipo_Lugar`,
       `ta_lugar`.`CV_Direccion`,
       `ta_lugar`.`CV_Ciudad`,
       `ta_lugar`.`CI_Pais`
FROM `femicidios`.`ta_lugar`;